...
IS_SIMULATION_ROBOT = int(os.getenv("IS_SIMULATION_ROBOT", "1")) # 1: Use Fake moves in Chess core / 0: Use engine next best move
IS_SIMULATION_USER = int(os.getenv("IS_SIMULATION_USER", "0")) # 1: Use Fake moves in Chess core / 0: Use engine next best move
...
core = GMCore(engine_side=ENGINE_SIDE, use_camera=USE_CAMERA, is_simulation_robot=IS_SIMULATION_ROBOT, is_simulation_user=IS_SIMULATION_USER, with_sound=WITH_SOUND,
